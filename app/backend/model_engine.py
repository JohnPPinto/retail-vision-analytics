...
class YoloDetectPredict:
    ...
    Parameters:
        ...
        iou_threshold: A float in the range (0, 1) for thresholding IoU while Non maximum suppression.
    """
    ...
    def process_output(self, output):
        ...
        # Apply Non Maximum Suppression(NMS) to suppress overlapping box
